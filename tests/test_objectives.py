...
async def test_get_objectives(client: AsyncClient):
    ...
    parse_response_to_dtos(response, ObjectiveOutgoingDto)
...
async def test_get_objective(client: AsyncClient):
    ...
    parse_response_to_dto(response, ObjectiveOutgoingDto)
...
async def test_update_objective(client: AsyncClient):
    ...
    response_content=parse_response_to_dtos(response, ObjectiveOutgoingDto)
