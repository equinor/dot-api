...
import src.routes.outcome_probability_routes as outcome_probability_routes
...
app.include_router(outcome_probability_routes.router, dependencies=[Depends(verify_token)])
