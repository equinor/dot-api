...
class Config(BaseSettings):
    ...
    SCOPE: str = Field(
        default=os.getenv("SCOPE", "4251833c-b9c3-4013-afda-cbfd2cc50f3f/Read")
    )
    ...
    DATABASE_CONN_LOCAL: str = Field(
        default=os.getenv("DATABASE_CONN_LOCAL", "DRIVER={ODBC Driver 18 for SQL Server};Server=127.0.0.1,1433;Database=decision-optimization-local;UID=sa;PWD=Local1234;trustservercertificate=yes;")
    )
