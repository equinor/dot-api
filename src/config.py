...
class Config(BaseSettings):
    ...
    DATABASE_CONN_LOCAL: str = Field(
        default=os.getenv("DATABASE_CONN_LOCAL", "DRIVER={ODBC Driver 18 for SQL Server};Server=127.0.0.1,1433;Database=decision-optimization-local;UID=sa;PWD=;TrustServerCertificate=yes;")
    )
