...
class EdgeService:
    ...
    async def create(self, session: AsyncSession, dtos: list[EdgeIncomingDto]) -> list[EdgeOutgoingDto]:
    ...
    async def update(self, session: AsyncSession, dtos: list[EdgeIncomingDto]) -> list[EdgeOutgoingDto]:
    ...
    async def get_all(self, session: AsyncSession, odata_query: Optional[str]=None, filter: Optional[EdgeFilter]=None) -> list[EdgeOutgoingDto]:
