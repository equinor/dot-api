...
class OptionService:
    async def create(self, session: AsyncSession, dtos: list[OptionIncomingDto]) -> list[OptionOutgoingDto]:
    ...
    async def update(self, session: AsyncSession, dtos: list[OptionIncomingDto]) -> list[OptionOutgoingDto]:
    ...
    async def get_all(self, session: AsyncSession, odata_query: Optional[str] = None) -> list[OptionOutgoingDto]:
