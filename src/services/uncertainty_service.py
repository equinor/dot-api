...
class UncertaintyService:
    async def create(self, session: AsyncSession, dtos: list[UncertaintyIncomingDto]) -> list[UncertaintyOutgoingDto]:
    ...
    async def update(self, session: AsyncSession, dtos: list[UncertaintyIncomingDto]) -> list[UncertaintyOutgoingDto]:
    ...
    async def get(self, session: AsyncSession, ids: list[uuid.UUID]) -> list[UncertaintyOutgoingDto]:
    ...
    async def get_all(self, session: AsyncSession, odata_query: Optional[str] = None) -> list[UncertaintyOutgoingDto]:
