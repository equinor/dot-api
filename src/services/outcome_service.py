...
class OutcomeService:
    async def create(self, session: AsyncSession, dtos: list[OutcomeIncomingDto]) -> list[OutcomeOutgoingDto]:
    ...
    async def update(self, session: AsyncSession, dtos: list[OutcomeIncomingDto]) -> list[OutcomeOutgoingDto]:
    ...
    async def get_all(self, session: AsyncSession, odata_query: Optional[str] = None) -> list[OutcomeOutgoingDto]:
