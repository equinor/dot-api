...
class ProjectRoleService:
    ...
    async def update(
        ...
        user = await UserRepository(session).get_by_azure_id(
        ...
        entities_project_role: list[ProjectRole] = await ProjectRoleRepository(
            session
        ).update(ProjectRoleMapper.to_project_role_entities(dtos))
        result: list[ProjectRoleOutgoingDto] = ProjectRoleMapper.to_outgoing_dtos(
