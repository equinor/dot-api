...
class OptionToOutcome(Base, BaseEntity):
    __tablename__ = "option_to_outcome"
    ...
    def __init__(self, id: uuid.UUID, parent_outcome_id: uuid.UUID, child_option_id: uuid.UUID, edge_id: uuid.UUID):
        self.id=id
