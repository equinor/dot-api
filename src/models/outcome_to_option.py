...
class OutcomeToOption(Base, BaseEntity):
    __tablename__ = "outcome_to_option"
    ...
    def __init__(self, id: uuid.UUID, parent_option_id: uuid.UUID, child_outcome_id: uuid.UUID, edge_id: uuid.UUID):
        self.id=id
